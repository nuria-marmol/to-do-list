...
const noTasks = ref(true) // for showing 'No tasks' paragraph
const zeroPending = ref(true) // for 'No pending tasks' paragraph
const zeroCompleted = ref(false) // for 'No completed tasks' paragraph
...
function changeListTitle() {
  ...
  // Passing the v-model to the title
...
function filteredTasks() {
  ...
  if (showChecked.value) { 
    ...
    // Showing 'No completed tasks' paragraph if the user deletes all
  ...
  // Filter by pending tasks
    ...
    // Showing 'No pending tasks' paragraph if the user deletes all
  ...
  // For showing all tasks. Hiding 'No pending' and 'No completed' messages
  zeroCompleted.value = false
  zeroPending.value = false
